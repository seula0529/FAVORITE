...
export const BEANS = [
  {
    ...
    ink: 'dark',
    tags: ['#너티', '#초콜릿', '#캐러멜', '#우디', '추구미 · 균형 잡힌 한 잔'],
  ...
  },
  {
    ...
    ink: 'dark',
    tags: ['#허니', '#플로럴', '#캐러멜', '#복숭아', '추구미 · 따뜻한 온기를 나누는 한 잔'],
  ...
  },
  {
    ...
    ink: 'dark',
    tags: ['#시트러스', '#오렌지', '#사과', '#레드베리', '추구미 · 활력을 채워주는 한 잔'],
  ...
  },
  {
    ...
    ink: 'dark',
    tags: ['#플로럴', '#자스민', '#복숭아', '#블루베리', '추구미 · 나만의 개성을 담은 한 잔'],
  ...
  },
  {
    ...
    ink: 'light',
    tags: ['#다크초콜릿', '#우디', '#허브', '#아몬드', '추구미 · 깊이 있는 풍미'],
  ...
  },
  {
    ...
    ink: 'dark',
    tags: ['#너티', '#캐러멜', '#밀크초콜릿', '#우디', '추구미 · 익숙하고 편안한 한 잔'],
  ...
  },
  {
    ...
    ink: 'dark',
    tags: ['#베리', '#열대과일', '#레몬', '#망고', '추구미 · 설렘과 즐거움을 주는 한 잔'],
  ...
  },
  {
    ...
    ink: 'light',
    tags: ['#스파이시', '#다크초콜릿', '#오크', '#스모키', '추구미 · 강렬한 존재감'],
  ...
  },
  {
    ...
    ink: 'dark',
    tags: ['#허브', '#허니 ', '#플로럴', '#배', '추구미 · 마음을 편안하게 하는 한 잔'],
